  ...
  const jobs = ref<Experiencia[]>([
    {
      ...
      descripcion: `Encargado de crear e optimizar modulos basados en los requerimientos, para una mejor experiencia al usuario. Seguimiento a proyecto creados con vue2 con mutaciones y vue3. Consumo de apis mediante postman para verificar la información.`,
      ...
      tareas: [
        ...
        { id: uuidv4(), task: 'Metodologia SCRUM' },
      ]
    },
    {
      id: uuidv4(),
